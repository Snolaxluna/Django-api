...
class ModelEstudanteTestCase(TestCase):
    ...
    def test_verifica_atributos_de_estudante(self):
        ...
        self.assertEqual(self.estudante.cpf, '20494563010')
...
class ModelMatriculaTestCase(TestCase):
    ...
    def test_verifica_atributos_de_matricula(self):
        ...
        self.assertEqual(self.matricula.estudante.nome,
                         'Teste Modelo Matricula')
        self.assertEqual(self.matricula.curso.descricao,
                         'Curso Teste Modelo Matricula')
